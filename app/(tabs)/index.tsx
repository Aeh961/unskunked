...
const quickLinks = [
  ...
  { label: "Weather", href: "/weather", icon: "partly-sunny", hint: "Score conditions" },
  { label: "Rules", href: "/regulations", icon: "shield-checkmark", hint: "Current summaries" },
  { label: "Offline", href: "/offline", icon: "download", hint: "Local packs" },
